...
- [workbox](https://github.com/GoogleChrome/workbox) - <g-emoji class="g-emoji" alias="package" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4e6.png">📦</g-emoji> 操作serviceworker等pwa概念非常方便的库，google出品。
...
## 文件操作
- [chokidar](https://www.npmjs.com/package/chokidar) - 一个对node.js fs.watch/fs.watchFile/FSEvents的简介封装
...
- [sinopia](https://github.com/rlidwka/sinopia) - 私有npm服务器
...
- [prisma](https://github.com/prisma/prisma) - <g-emoji class="g-emoji" alias="floppy_disk" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4be.png">💾</g-emoji> 数据库工具，用来代替传统ORM。
...
- [localtunnel](https://www.npmjs.com/package/localtunnel) - 将您的localhost暴露给世界，以便于测试和共享
...
- [imagesloaded](https://github.com/desandro/imagesloaded) - <g-emoji class="g-emoji" alias="camera" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4f7.png">📷</g-emoji> 判断所有图片列表是否加载完成
...
- [mocha](https://github.com/mochajs/mocha) - <g-emoji class="g-emoji" alias="coffee" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/2615.png">☕️</g-emoji> 简单灵活的测试框架
- [nightwatch](https://www.npmjs.com/package/nightwatch) - 由Node.js提供支持并使用W3C Webdriver（以前称为Selenium）的自动化测试框架。
- [nyc](https://github.com/istanbuljs/nyc) - Istanbul 命令行接口
...
- [uirecorder](https://www.npmjs.com/package/uirecorder) - UI自动化，阿里出品
- []() - 
...
- [InversifyJS](https://github.com/inversify/InversifyJS) - 强大而轻量级的IOC框架，微软，facebook使用
