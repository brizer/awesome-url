...
- [react-flow](https://github.com/wbkd/react-flow) - 工作流，可视化编排组件，非常灵活，react生态，很多大模型编排都是基于此 ![img](https://img.shields.io/github/stars/wbkd/react-flow)
...
- [Dexie.js](https://github.com/dexie/Dexie.js) - IndexedDB的驱动层 ![img](https://img.shields.io/github/stars/dexie/Dexie.js)
...
- [progress](https://www.npmjs.com/package/progress) - cli进度条
...
- [devtools-frontend](https://github.com/ChromeDevTools/devtools-frontend) - chrome的开发者工具组件 ![img](https://img.shields.io/github/stars/ChromeDevTools/devtools-frontend)
...
- [egjs-infinitegrid](https://github.com/naver/egjs-infinitegrid) - 瀑布流组件，兼容各种前端框，用来下感觉不太好用 ![img](https://img.shields.io/github/stars/naver/egjs-infinitegrid)
...
- [viewerjs](https://github.com/fengyuanchen/viewerjs) - 非常优秀的图片查看器组件，不依赖框架 ![img](https://img.shields.io/github/stars/fengyuanchen/viewerjs)
...
## 请求
- [Ajax-hook](https://github.com/wendux/Ajax-hook) - 拦截请求并回调 ![img](https://img.shields.io/github/stars/wendux/Ajax-hook)
...
- [StreamSaver.js](https://github.com/jimmywarting/StreamSaver.js) - 类似filesaver，但是模拟了服务器的流程，可以用来快速的下载大文件（直接使用Filesaver则需要等待文件blob被操作完，非常慢） ![img](https://img.shields.io/github/stars/jimmywarting/StreamSaver.js)
...
- [x-render](https://github.com/alibaba/x-render) -  表单生成器和表格生成器，由阿里巴巴开发，仅仅支持react ![img](https://img.shields.io/github/stars/alibaba/x-render)
...
- [form-create](https://github.com/xaboy/form-create) - 一款星最多，schema最简单的动态表单，支持vue2、vue3、element、elementplus等多个组件库 ![img](https://img.shields.io/github/stars/xaboy/form-create)
...
- [capture-website-cli](https://github.com/sindresorhus/capture-website-cli) - 在命令行对指定url进行截图 ![img](https://img.shields.io/github/stars/sindresorhus/capture-website-cli)
...
- [disable-devtool](https://github.com/theajack/disable-devtool) - 禁用各种前端调试，各种反调试 ![img](https://img.shields.io/github/stars/theajack/disable-devtool)
...
- [videojs-markers](https://github.com/spchuang/videojs-markers) - videojs进度条锚点插件 ![img](https://img.shields.io/github/stars/spchuang/videojs-markers)
...
- [connect-history-api-fallback#readme](https://github.com/bripkens/connect-history-api-fallback#readme) - 配合前端路由history模式的后端中间件 ![img](https://img.shields.io/github/stars/bripkens/connect-history-api-fallback#readme)
...
- [node-cron](https://github.com/kelektiv/node-cron) - Node中定时任务 ![img](https://img.shields.io/github/stars/kelektiv/node-cron)
...
- [postcss](https://github.com/postcss/postcss) - 转换样式的css插件
- [rough-notation](https://github.com/rough-stuff/rough-notation) - 手绘风格的样式库，非常适合阅读笔记等应用场景 ![img](https://img.shields.io/github/stars/rough-stuff/rough-notation)
...
- [devalue](https://github.com/Rich-Harris/devalue) - jsonapi的各种格式兼容版 ![img](https://img.shields.io/github/stars/Rich-Harris/devalue)
...
- [kkFileView](https://github.com/kekingcn/kkFileView) - 史上最强文件pdf word等的阅读器，可以渲染各种文档的中间件服务 ![img](https://img.shields.io/github/stars/kekingcn/kkFileView)
...
- [officegen](https://github.com/Ziv-Barber/officegen) - Word (docx)、PowerPoint (pptx) 和 Excell (xlsx) 的独立 Office Open XML 文件（Microsoft Office 2007 及更高版本）生成器 ![img](https://img.shields.io/github/stars/Ziv-Barber/officegen)
