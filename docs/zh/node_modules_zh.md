...
- [fabric.js](https://github.com/fabricjs/fabric.js) - SVG和canvas互转的库
- [imagemin](https://github.com/imagemin/imagemin) - 压缩图片大小
...
- [svgo](https://github.com/svg/svgo) - <g-emoji class="g-emoji" alias="tiger" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f42f.png">🐯</g-emoji> 优化svg图片的大小，性能优化时非常有效
...
- [memfs](https://github.com/streamich/memfs) - 内存中的fs模块，用于mock
